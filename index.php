...
mkdir('data/txt');
mkdir('data/api');
$API_KEY= '8248750533:AAFepQzFnCGIDkemlyfipgRHFUj0GCmxnYM';//توكن بوتك
...
$bot="kkkk";  #اسم الملف الي مسويه بالاستضافه
...
$assignru=0.05; #نسبة ربح رابط الدعوة#
...
[['text'=>"𓆩•|ــــــــــ($namebot)ـــــــــ|•𓆪", 'url'=>"http://t.me/$usrch3"]]
]
])
]);
exit;
...
[['text'=>' ✥ عروض Telegram   🎯٭','callback_data'=>"Cw-36"],['text'=>' ✥ عروض الوتس اب  🎯٭','callback_data'=>"Wo"]],[['text'=>' ✥ تحويل الرصيد   ↻٭','callback_data'=>"YESSend"],['text'=>' ✥ أشحن رصيدك  🎳٭','callback_data'=>'Payment']],
...
#=========={القائمه الرئيسية عبر الامر . قم بكتابه الامر هنا بدلا من /dabah}==========#
if($text == $zozamr){
if($EM == null or $EMILS['emils'][$EM]['emil'] == null or $passewo != $perrewo){
bot('sendMessage',[
'chat_id'=>$chat_id,
...
𓆩•|ــــــــــ(𝐃𝐀𝐁𝐀𝐇 𝐍𝗨𝐌𝐁𝐄𝐑)ـــــــــ|•𓆪
",
'parse_mode'=>"MarkDown",
'reply_markup'=>($keyboad),
]);
